...
// Allocate space for a string object that represents the empty
...
// The memory used for the MY_STRING object has be reclaimed by
// the system and the handle referred to by the pointer phMy_string has been
// set to NULL.
void my_string_destroy(Item *pItem);

// Allocate space for a string object that represents a string
...
// Returns an integer less than zero if the string represented
...
// hMy_string will be the handle of a string object that contains
...
// Writes the characters contained in the string object indicated
...
// If successful, places the character item at the end of the
...
// Removes the last character of a string in constant time.
...
// Returns the address of the character located at the given
...
// Returns the address of the first element of the string object
...
// hResult is the handle of a string that contains the original
...
// Returns an enumerated type with value TRUE if the string
